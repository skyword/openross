...
* Crop does what you think it does, and crops an image into a given size. (No, actually it doesn't.  It crops it based on the center of the image.  You do not get to pick x1, x2, y1, y2, etc. See Fullcrop below).
